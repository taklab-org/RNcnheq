% After #### (->##) steps, the integrator fails
% Execute time is about ###(-> 164) sec
...
N = 20; % # of Fourier coefficients / ?? is best? (angle = 0)
n = 15; % # of Chebyshev coefficients / ?? is best? (angle = 0)
...
for timestep = 1:1e4
  ...
  if kappa>0
    ...
    stepsize = stepsize/2;
    tspan(2) = tspan(1) + stepsize;% shorten time step
    continue
  end
