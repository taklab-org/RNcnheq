function [r_minus,success] = int_radii_polynomial_variational_equation(C,ta,angle,h,N,n,m,n_pad_cheb,nu)
...
iDF = int_DF_Fourier_Chebyshev(ita,iangle,ih,N,n,m);
DF = mid(iDF);
...
for j = 1:2*m+1
    ...
    F_ext = int_F_Fourier_Chebyshev_ext(c,ita,b,angle,h,N,n,m);
